...
export async function generateMetadata({
  ...
  return generateSeoMetadata({
    ...
    pathname: "/shop",
    keywords: locale === "ar"
      ? ["تسوق عطور", "عطور فاخرة", "زيوت عطرية", "عناية بالجسم", "معطرات منزل", "عطور عربية", "عطور إماراتية", "شراء عطور", "عود عربي", "بخور", "عطور نسائية", "عطور رجالية", "هدايا عطرية", "عطور طبيعية", "عطور دبي", "عطور مسك", "عطور عنبر", "عطور أصلية الإمارات", "متجر عطور أون لاين", "عطور فانيلا", "عطور جلد", "أفضل عطور الإمارات", "متجر أروماتيك للعطور", "متجر أروماتيك الإمارات", "مجموعة عطور أروماتيك", "عطر جيد أون لاين", "عطور فاخرة بأسعار مناسبة", "أفضل كولونيا عطرية", "عطور رجالية ونسائية أون لاين", "منتجات عناية معطرة", "زيوت معطرة أروماتيك", "رائحة عطرية مميزة الإمارات"]
