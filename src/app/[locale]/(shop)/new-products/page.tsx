...
const defaultSeo = {
  ...
  description: {
    en: "Discover our newest luxury perfumes, Arabian oud & aromatic oils from Aromatic Scents Lab. Handcrafted in the UAE. Free delivery on orders over 500 AED.",
    ar: "اكتشف أحدث إصداراتنا من العطور الفاخرة والعود العربي والزيوت العطرية من Aromatic Scents Lab. منتجات يدوية فاخرة من الإمارات. توصيل مجاني للطلبات فوق 500 درهم.",
  },
  keywords: {
