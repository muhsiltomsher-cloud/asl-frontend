...
const stores: Store[] = [
  {
    ...
    image: "https://admin.aromaticscentslab.com/wp-content/uploads/2025/12/ASL-Website-Images-Patchouli-Glow-06.webp",
  },
  {
    id: 2,
    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[50vh] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="https://admin.aromaticscentslab.com/wp-content/uploads/2025/12/ASL-Website-Images-Patchouli-Glow-06.webp"
            alt="Store Locator"
            fill
