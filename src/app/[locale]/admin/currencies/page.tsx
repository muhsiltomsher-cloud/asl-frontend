      ...
      <div className="mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  How much of this currency equals 1 AED. Example: 0.27 USD = 1 AED
                </p>
              </div>
            </div>
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        className="rounded p-1.5 text-gray-500 hover:bg-gray-100 hover:text-amber-700 transition-colors"
                        title="Edit"
                        disabled={saving}
                      >
        ...
        <div className="mt-6 rounded-lg bg-blue-50 border border-blue-200 p-4">
          ...
          <p className="text-sm text-blue-700">
            Exchange rates are relative to AED (UAE Dirham) as the base currency. 
            For example, if 1 AED = 0.27 USD, enter 0.27 as the rate for USD.
            The system will automatically convert prices from AED to the selected currency.
          </p>
        </div>
      </div>
    </div>
