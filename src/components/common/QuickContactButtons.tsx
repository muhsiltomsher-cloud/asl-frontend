    ...
    <div className="flex flex-wrap items-center justify-center gap-4">
      <a
        ...
        rel="noopener noreferrer"
              className="group flex items-center gap-3 rounded-full bg-gradient-to-r from-[#c67a46] to-[#633d1f] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#c67a46]/20 transition-all duration-300 hover:from-[#633d1f] hover:to-[#4a2d17] hover:shadow-xl hover:shadow-[#633d1f]/30"
            >
