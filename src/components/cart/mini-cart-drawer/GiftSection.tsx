...
export function GiftSection({ locale, currency, giftProgress, activeGifts }: GiftSectionProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-[#f7f6f2] to-orange-50 border-b border-[#b2a896]">
      {giftProgress.hasNextGift && (
        <div className="p-3 border-b border-[#b2a896] bg-white/50">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-[#c67a46] to-orange-400 flex-shrink-0">
              <Gift className="h-4 w-4 text-white" />
            </div>
            <div className="flex-1">
              <p className="text-xs font-semibold text-[#633d1f]">
                {isRTL 
          ...
          <div className="mt-2 h-1.5 bg-[#f7f6f2] rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-[#c67a46] to-orange-500 rounded-full transition-all duration-500"
              style={{ 
      ...
      {activeGifts.length > 0 && (
        <div className="p-3">
          <p className="text-xs font-semibold text-[#633d1f] mb-2">
          ...
          <div className="space-y-1">
            {activeGifts.map((gift, index) => (
              <div key={index} className="flex items-center gap-2 bg-white/60 rounded px-2 py-1">
                ...
                <span className="text-xs text-[#633d1f] flex-1">
