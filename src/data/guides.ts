...
export const guides: Guide[] = [
  ...
  // ==========================================================================
  {
    ...
    products: [
      { slug: "dark-wood", rank: 1, pickReason: { en: "Best Woody — Dark Wood | Woody | Bergamot, Caramel, Cardamom, Cedarwood, Vetiver", ar: "أفضل خشبي — دارك وود" }, description: { en: "Dark Wood | Woody | Top: Bergamot | Heart: Caramel, Cardamom | Base: Cedarwood, Vetiver. The definitive woody fragrance — warm, earthy, endlessly versatile.", ar: "دارك وود هو العطر الخشبي الأمثل — دافئ وترابي ومتعدد الاستعمالات بلا حدود. تركيبته الخشبية تبدأ بالبرغموت المنعش، مع قلب دافئ من الكراميل والهيل، وقاعدة راسخة من خشب الأرز والفيتيفر. مزيج خشبي طبيعي وأنيق يناسب كل مناسبة وكل موسم." } },
      ...
      { slug: "secret-leather-perfume", rank: 4, pickReason: { en: "Woody Leather — Secret Leather | Oriental | Orris, Cypress, Tonka Bean", ar: "جلد خشبي — سيكرت ليذر" }, description: { en: "Secret Leather | Oriental | Top: Orris | Heart: Leather, Cypress | Base: Tonka Bean, Musk. Cypress provides an aromatic woody dimension.", ar: "سيكرت ليذر يضيف بُعداً خشبياً عطرياً بفضل السرو في قلبه. تركيبته الشرقية تجمع بين الأوريس النبيل في القمة، والجلد الناعم والسرو الخشبي في القلب، وحبوب التونكا والمسك في القاعدة. السرو يمنحه طابعاً خشبياً عطرياً يكمل جاذبية الجلد." } },
      { slug: "dark-musk-perfume", rank: 5, pickReason: { en: "Woody Musk — Dark Musk | Oriental Musky | Cypriol, Guaiac Wood, Ambergris", ar: "مسك خشبي — المسك الداكن" }, description: { en: "Dark Musk | Oriental Musky | Top: Mandarin, Praline | Heart: Cypriol, Guaiac wood | Base: Ambergris, Musk. Guaiac wood and cypriol lend rich woody character.", ar: "المسك الداكن يتميز بطابع خشبي غني بفضل خشب الجواياك والسيبريول في قلبه. تركيبته المسكية الشرقية تبدأ بالماندرين والبرالين، مع قلب غني من السيبريول وخشب الجواياك، وقاعدة من العنبر الأشهب والمسك. خشب الجواياك يمنحه عمقاً خشبياً طبيعياً واستثنائياً." } },
    ],
    contentBlocks: [
  ...
  // ==========================================================================
  {
    ...
    products: [
      ...
      { slug: "secret-leather-perfume", rank: 3, pickReason: { en: "Best for Men — Secret Leather | Oriental | Orris, Leather, Cypress, Tonka, Musk", ar: "أفضل للرجال — سيكرت ليذر" }, description: { en: "Secret Leather | Oriental | Top: Orris | Heart: Leather, Cypress | Base: Tonka Bean, Musk. Bold leather that resonates with Saudi men.", ar: "سيكرت ليذر عطر جلدي جريء يتوافق تماماً مع ذوق الرجل السعودي. تركيبته الشرقية تجمع بين الأوريس النبيل في القمة، والجلد الناعم والسرو في القلب، وحبوب التونكا والمسك في القاعدة. قوة وحضور يعكسان شخصية الرجل السعودي الواثق." } },
      { slug: "velvet-amber-perfume", rank: 4, pickReason: { en: "Most Elegant — Velvet Amber | Ambry | Lily, Cedarwood, Sandalwood, Musk", ar: "الأكثر أناقة — فلفت أمبر" }, description: { en: "Velvet Amber | Ambry | Top: Lily of the Valley | Heart: Cedarwood, Dry Amber | Base: Sandalwood, Musk. Elegant warmth for formal occasions.", ar: "فلفت أمبر يمنحك دفئاً أنيقاً يليق بالمناسبات الرسمية في المملكة. تركيبته العنبرية الراقية تبدأ بزنبق الوادي المنعش، مع قلب من خشب الأرز والعنبر الجاف، وقاعدة من خشب الصندل والمسك. أناقة سعودية تعكس الذوق الرفيع والاحترام للتقاليد." } },
      { slug: "dark-wood", rank: 5, pickReason: { en: "Best Woody — Dark Wood | Woody | Bergamot, Cardamom, Cedarwood, Vetiver", ar: "أفضل خشبي — دارك وود" }, description: { en: "Dark Wood | Woody | Top: Bergamot | Heart: Caramel, Cardamom | Base: Cedarwood, Vetiver. Versatile and grounded, a Saudi gentleman's favourite.", ar: "دارك وود عطر خشبي متعدد الاستعمالات وراسخ — المفضل لدى الرجل السعودي الأنيق. تركيبته تبدأ بالبرغموت المنعش، مع قلب دافئ من الكراميل والهيل، وقاعدة من خشب الأرز والفيتيفر. عطر خشبي يومي يعكس الأناقة السعودية الأصيلة." } },
    ],
    contentBlocks: [
  ...
  // ==========================================================================
  {
    ...
    products: [
      { slug: "dark-musk-perfume", rank: 1, pickReason: { en: "Kuwait Favourite — Dark Musk | Oriental Musky | Mandarin, Praline, Ambergris, Musk", ar: "المفضل في الكويت — المسك الداكن" }, description: { en: "Dark Musk | Oriental Musky | Top: Mandarin, Praline | Heart: Cypriol, Guaiac wood | Base: Ambergris, Musk. Rich, warm, and long-lasting.", ar: "المسك الداكن عطر غني ودافئ وطويل الأمد — المفضل الأول لدى عشاق العطور في الكويت. تركيبته المسكية الشرقية تبدأ بالماندرين والبرالين، مع قلب من السيبريول وخشب الجواياك، وقاعدة فاخرة من العنبر الأشهب والمسك. ثبات استثنائي يصحبك طوال اليوم." } },
      { slug: "secret-leather-perfume", rank: 2, pickReason: { en: "Best Men's — Secret Leather | Oriental | Orris, Leather, Cypress, Tonka, Musk", ar: "أفضل للرجال — سيكرت ليذر" }, description: { en: "Secret Leather | Oriental | Top: Orris | Heart: Leather, Cypress | Base: Tonka Bean, Musk. Bold, powerful, and sophisticated.", ar: "سيكرت ليذر عطر جريء وقوي ومتطور — يناسب شغف الكويتيين بالعطور الفاخرة. تركيبته الشرقية تجمع بين الأوريس النبيل في القمة، والجلد الناعم والسرو في القلب، وحبوب التونكا والمسك في القاعدة. حضور قوي يليق بالديوانية والمناسبات الراقية." } },
      { slug: "velvet-amber-perfume", rank: 3, pickReason: { en: "Best Women's — Velvet Amber | Ambry | Lily, Cedarwood, Sandalwood, Musk", ar: "أفضل للنساء — فلفت أمبر" }, description: { en: "Velvet Amber | Ambry | Top: Lily of the Valley | Heart: Cedarwood, Dry Amber | Base: Sandalwood, Musk. Elegant and refined.", ar: "فلفت أمبر عطر أنيق وراقٍ — الاختيار الأمثل للمرأة الكويتية المتميزة. تركيبته العنبرية المتطورة تبدأ بزنبق الوادي المنعش، مع قلب من خشب الأرز والعنبر الجاف، وقاعدة من خشب الصندل والمسك. أناقة دافئة ومصقولة تليق بالمناسبات الكويتية الراقية." } },
  ...
  // ==========================================================================
  {
    ...
    products: [
      { slug: "dark-musk-perfume", rank: 1, pickReason: { en: "Top Pick — Dark Musk | Oriental Musky | Mandarin, Praline, Ambergris, Musk", ar: "الاختيار الأول — المسك الداكن" }, description: { en: "Dark Musk | Oriental Musky | Top: Mandarin, Praline | Heart: Cypriol, Guaiac wood | Base: Ambergris, Musk. Qatar's most requested fragrance.", ar: "المسك الداكن هو العطر الأكثر طلباً في قطر بفضل تركيبته المسكية الشرقية الفاخرة. يبدأ بالماندرين والبرالين، مع قلب من السيبريول وخشب الجواياك، وقاعدة غنية من العنبر الأشهب والمسك. عطر يعكس الذوق القطري الرفيع بعمقه وثباته الاستثنائي." } },
  ...
  // ==========================================================================
  {
    ...
    products: [
      ...
      { slug: "velvet-amber-perfume", rank: 4, pickReason: { en: "Iftar Gatherings — Velvet Amber | Ambry | Lily, Cedarwood, Sandalwood, Musk", ar: "تجمعات الإفطار — فلفت أمبر" }, description: { en: "Velvet Amber | Ambry | Top: Lily of the Valley | Heart: Cedarwood, Dry Amber | Base: Sandalwood, Musk. Warm and inviting for family gatherings.", ar: "فلفت أمبر عطر دافئ وجذاب مثالي لتجمعات الإفطار العائلية في رمضان. تركيبته العنبرية الأنيقة تبدأ بزنبق الوادي المنعش، مع قلب من خشب الأرز والعنبر الجاف، وقاعدة من خشب الصندل والمسك. دفء عنبري حميم يعزز أجواء المحبة والترابط العائلي." } },
  ...
  // ==========================================================================
  {
    ...
    products: [
      ...
      { slug: "secret-leather-perfume", rank: 3, pickReason: { en: "Best for Men — Secret Leather | Oriental | Orris, Leather, Cypress, Tonka, Musk", ar: "أفضل للرجال — سيكرت ليذر" }, description: { en: "Secret Leather | Oriental | Top: Orris | Heart: Leather, Cypress | Base: Tonka Bean, Musk. Bold, confident — a man's perfect Eid gift.", ar: "سيكرت ليذر هو هدية العيد المثالية للرجل الواثق. تركيبته الشرقية الجريئة تجمع بين الأوريس النبيل في القمة، والجلد الناعم والسرو في القلب، وحبوب التونكا والمسك في القاعدة. جرأة وثقة في قارورة أنيقة تليق بفرحة العيد." } },
  ...
  // ==========================================================================
  {
    ...
    products: [
      ...
      { slug: "white-bouquet-perfume", rank: 2, pickReason: { en: "Freshest — White Bouquet | White Floral | Jasmine, Rose, Peony, White Musk", ar: "الأكثر انتعاشاً — وايت بوكيه" }, description: { en: "White Bouquet | White Floral | Top: Bergamot, Pink Pepper | Heart: Jasmine, Rose, Peony | Base: White Musk, Cedarwood. Clean, fresh, and perfectly office-appropriate.", ar: "وايت بوكيه عطر منعش ونظيف ومناسب تماماً لبيئة المكتب. باقة زهرية بيضاء تبدأ بالبرغموت والفلفل الوردي، مع قلب من الياسمين والورد والفاوانيا، وقاعدة من المسك الأبيض وخشب الأرز. نضارة زهرية خفيفة ومهنية تناسب يوم العمل بالكامل." } },
      { slug: "dark-wood", rank: 3, pickReason: { en: "Best for Men — Dark Wood | Woody | Bergamot, Cardamom, Cedarwood, Vetiver", ar: "أفضل للرجال — دارك وود" }, description: { en: "Dark Wood | Woody | Top: Bergamot | Heart: Caramel, Cardamom | Base: Cedarwood, Vetiver. Professional and understated.", ar: "دارك وود عطر مهني وراقٍ بامتياز. تركيبته الخشبية المتحفظة تبدأ بالبرغموت المنعش، مع قلب دافئ من الكراميل والهيل، وقاعدة من خشب الأرز والفيتيفر. انتشار هادئ ومحترف يناسب بيئة المكتب دون أن يلفت الانتباه بشكل مفرط." } },
  ...
  // ==========================================================================
  {
    ...
    products: [
      ...
      { slug: "dark-wood", rank: 2, pickReason: { en: "Fresh Woody — Dark Wood | Woody | Bergamot, Cardamom, Cedarwood, Vetiver", ar: "خشبي منعش — دارك وود" }, description: { en: "Dark Wood | Woody | Top: Bergamot | Heart: Caramel, Cardamom | Base: Cedarwood, Vetiver. Bergamot opening keeps it fresh in heat.", ar: "دارك وود يبقى منعشاً في الحرارة بفضل افتتاحيته من البرغموت. تركيبته الخشبية تبدأ بالبرغموت المنعش الذي يتحمل الحرارة، مع قلب من الكراميل والهيل، وقاعدة من خشب الأرز والفيتيفر. عطر خشبي صيفي يحافظ على انتعاشه حتى في أشد أيام الصيف حرارة." } },
  ...
  // ==========================================================================
  {
    ...
    products: [
      { slug: "dark-musk-perfume", rank: 1, pickReason: { en: "Winter King — Dark Musk | Oriental Musky | Mandarin, Praline, Ambergris, Musk", ar: "ملك الشتاء — المسك الداكن" }, description: { en: "Dark Musk | Oriental Musky | Top: Mandarin, Praline | Heart: Cypriol, Guaiac wood | Base: Ambergris, Musk. Rich, warm, and powerful — designed for cooler weather.", ar: "المسك الداكن هو ملك عطور الشتاء — غني ودافئ وقوي ومصمم للطقس البارد. تركيبته المسكية الشرقية تبدأ بالماندرين والبرالين، مع قلب من السيبريول وخشب الجواياك، وقاعدة من العنبر الأشهب والمسك. الهواء البارد يعزز انتشاره وعمقه بشكل مثالي." } },
  ...
  // ==========================================================================
  {
    ...
    products: [
      ...
      { slug: "dark-musk-perfume", rank: 3, pickReason: { en: "Spray Option — Dark Musk EDP | Oriental Musky | Mandarin, Praline, Ambergris, Musk", ar: "خيار بخاخ — المسك الداكن" }, description: { en: "Dark Musk | Oriental Musky | Top: Mandarin, Praline | Heart: Cypriol, Guaiac wood | Base: Ambergris, Musk. The EDP version for those who prefer sprays.", ar: "المسك الداكن نسخة أو دو بارفان لمن يفضلون البخاخات على الزيوت. تركيبته المسكية الشرقية نفسها تبدأ بالماندرين والبرالين، مع قلب من السيبريول وخشب الجواياك، وقاعدة من العنبر الأشهب والمسك. انتشار أوسع من الزيت مع سحابة عطرية محيطة." } },
